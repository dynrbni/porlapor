...
export default function LocationPicker({ onLocationChange }: LocationPickerProps) {
  ...
  return (
    <div className="flex flex-col">
      <div className="h-56 w-full relative overflow-hidden bg-slate-200 z-0">
        ...
        <div className="absolute top-2 right-2 bg-white/90 backdrop-blur px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest rounded-lg shadow-sm z-[1000] pointer-events-none">
          GPS Active
        </div>
      </div>
      <div className="bg-slate-50 p-4 border-t border-slate-200 flex justify-between items-start gap-4">
