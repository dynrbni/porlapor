  ...
  return (
    <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50 min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-white/10 via-white/60 to-slate-50"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 data-aos="fade-up" className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-slate-900 tracking-tight mb-8 leading-[1.1]">
            Layanan Pengaduan Publik <span className="text-blue-600">Terbuka & Transparan.</span>
          </h1>
          ...
          <div data-aos="fade-up" data-aos-delay="200" className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-lg transition-all shadow-lg hover:shadow-blue-500/25 flex items-center justify-center gap-2 group cursor-pointer">
              Tulis Laporan Baru
            ...
            <div className="w-full sm:w-auto relative">
              ...
              <input 
                ...
                className="w-full sm:w-72 pl-12 pr-4 py-4 bg-white border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none rounded-xl font-medium text-slate-900 transition-all shadow-sm placeholder:text-slate-400"
              />
            </div>
          </div>
        </div>
